...
% tufte-handout + resize package bug:
% https://groups.google.com/group/tufte-latex/browse_thread/thread/30354db116115a15?pli=1
...
\begin{figure}
<<pdf-dev,dev=pdf,out.width=\linewidth,echo=FALSE,dependson=my-label>>=
	print(p1)
@
