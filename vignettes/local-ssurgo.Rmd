...
## 2. Create a Local SSURGO Database
...
## 3. Load and Explore the Database
...
## 5. Query and Aggregation Functions
...
For users who prefer a Python-based or cross-platform solution, the [SSURGOPortal R package](https://github.com/brownag/SSURGOPortalR) wraps the official [SSURGO Portal Python](https://www.nrcs.usda.gov/resources/data-and-reports/ssurgo-portal) code for use in R.
