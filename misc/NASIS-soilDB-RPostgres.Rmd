...
```{r, eval=TRUE}
library(soilDB)
tnames <- soilDB:::.get_NASIS_table_name_by_purpose()

res <- createStaticNASIS(tnames, output_path = outcon, dsn = "~/workspace/NASISlite/nasis_local.db")
...
The user sets up their own custom DBIConnection as needed.
