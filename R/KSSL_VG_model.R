...
#' 
#' This function was developed to work with measured or estimated parameters of
#' the \href{https://en.wikipedia.org/wiki/Water_retention_curvevan Genuchten
#' model}, as generated by the
...
#' model}. As such, \code{VG_params} should have the following format and
...
#' @note A practical example is given in the
#' \href{http://ncss-tech.github.io/AQP/soilDB/fetchSCAN-demo.htmlfetchSCAN
#' tutorial}.
#' @author D.E. Beaudette
#' @references \href{https://en.wikipedia.org/wiki/Water_retention_curvewater
