...
```
    ...
    ## Dimension:     XY
    ## Bounding box:  xmin: -120.8303 ymin: 37.98283 xmax: -120.7807 ymax: 38.00087
    ## Geodetic CRS:  WGS 84
    ##     mukey   area_ac                           geom
    ## 1 2924886  6.788244 POLYGON ((-120.8201 37.9839...
    ## 2 2450844 30.732837 POLYGON ((-120.7897 37.9864...
    ## 3 2924752 11.813110 POLYGON ((-120.7836 37.9887...
    ## 4 2441798 32.166563 POLYGON ((-120.7884 37.9883...
    ## 5 2766836 59.917135 POLYGON ((-120.7884 37.9883...
    ## 6 2450844 12.827506 POLYGON ((-120.8299 37.9976...
...
```
    ...
    ## Geometry type: POLYGON
    ## Dimension:     XY
    ## Bounding box:  xmin: -121.0731 ymin: 37.02103 xmax: -119.8417 ymax: 38.18986
    ## Geodetic CRS:  WGS 84
    ...
    ## 6 660960         US          q5s9 United States
    ##                                 muname farmlndcl                           geom
    ## 1 Whiterock-Rock outcrop-Auburn (s818)      <NA> POLYGON ((-120.5276 37.9624...
    ## 2 Whiterock-Rock outcrop-Auburn (s818)      <NA> POLYGON ((-120.794 38.18986...
    ## 3 Whiterock-Rock outcrop-Auburn (s818)      <NA> POLYGON ((-119.8862 37.0485...
    ## 4                  Peters-Pentz (s836)      <NA> POLYGON ((-120.9141 38.0735...
    ## 5       Finrod-Cogna-Archerdale (s857)      <NA> POLYGON ((-120.9711 37.9490...
    ## 6       Finrod-Cogna-Archerdale (s857)      <NA> POLYGON ((-120.7151 37.7056...
